const Group = () => {
  return (
    <section className=" max-container padding-container flex flex-col gap-10 py-5 pb-32 md:gap-28 lg:py-20">
      <img src="/group.jpg" alt="group photo"></img>
      <h2 className="lg:px-40 regular-24">YMT Toronto Lion Dance</h2>
